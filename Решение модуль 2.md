...
```
> [!CAUTION]
> На этом этапе заходим на HQ-CLI, и через Firefox пробуем зайти на 192.168.3.10:8080. Если открылся сайт и есть возможность взаимодействовать с таблицей - задание выполнено
