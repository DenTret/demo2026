...
apt-get update && apt-get install -y dos2unix curl
curl -o /etc/ansible/inventory.yml https://raw.githubusercontent.com/shiraorie/demo2026-1/main/files/inventory.yml
